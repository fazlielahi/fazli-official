...
@section('content')
    <div class="about-top">
        ...
        <div class="photo-slider">
            <div id="slider">
                <div class="portfolio">
                    <img src="{{ asset('images/slider2.jpg') }}" alt="test" /><br />
                    <div class="ombra"></div>
                </div>

                <div class="portfolio">
                    <img src="{{ asset('images/slider1.jpg') }}" alt="test" /><br />
                    <div class="ombra"></div>
                </div>

                <div class="portfolio">
                    <img src="{{ asset('images/slider3.jpg') }}" alt="test" /><br />
                    <div class="ombra"></div>
                </div>

                <div class="portfolio">
                    <img src="{{ asset('images/slider4.jpg') }}" alt="test" /><br />
                    <div class="ombra"></div>
                </div>

                <div class="portfolio 2ndlast-photo">
                    <img src="{{ asset('images/slider5.jpg') }}" alt="test" /><br />
                    <div class="ombra"></div>
                </div>

                <div class="portfolio last-photo">
                    <img src="{{ asset('images/blackhatmea24.jpg') }}" alt="test" /><br />
                    <div class="ombra"></div>
                </div>
