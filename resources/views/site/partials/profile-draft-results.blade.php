@if($blogs->count() > 0)
    @foreach($blogs as $blog)
        <div class="blog-card-blogs profile-draft-card">
            <div class="blog-two__single">
                ...
                <div class="blog-two__content">
                    <div class="blog-card__meta-row">
                        ...
                        <span class="profile-draft-card__badge">{{ __('lang.Draft') }}</span>
                    </div>
...
@else
    <div class="no-blogs-message">
        <i class="fas fa-file-pen fa-3x mb-3" aria-hidden="true"></i>
        <h4>
            {{ __('lang.Profile no draft blogs', ['name' => explode(' ', $user->name)[0]]) }}
        </h4>
        <p>{{ !empty($selectedCategory) ? __('lang.Profile no draft blogs filtered') : __('lang.Profile draft empty hint') }}</p>
    </div>
@endif

@if($blogs->hasPages())
    <nav class="blogs-pagination" aria-label="{{ __('lang.Draft') }}">
