    ...
    <div class="cv-builder">
        ...
        <div class="builder-form-panel">
            ...
            <form id="cv-form">
                ...
                <!-- Export PDF Section -->
                <div class="form-group" style="margin-top: 20px; padding-top: 20px; border-top: 2px solid #28a745;">
                    <button type="button" id="btn-export-pdf" class="btn-export-pdf" style="width: 100%; padding: 12px; background: #28a745; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; font-weight: 600;">
                        📄 Download PDF
                    </button>
                    <div id="export-message" style="margin-top: 10px; font-size: 12px;"></div>
                </div>
            </form>
        </div>
