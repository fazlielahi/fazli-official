                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($experience->company_logo)
                                            <div class="mb-2">
                                                <img src="{{ Storage::url($experience->company_logo) }}" alt="{{ $experience->company_name }}" style="max-width: 100px; max-height: 100px; border-radius: 50%;">
                                            </div>
                                        @endif
                                        ...
                                        @foreach($experience->media_images as $imagePath)
                                            <div class="col-md-3 mb-2 existing-media-item" data-image-path="{{ $imagePath }}">
                                                <div class="position-relative">
                                                    <img src="{{ Storage::url($imagePath) }}" style="width: 100%; height: 150px; object-fit: cover; border-radius: 5px;">
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.remove-existing-media')) {
            ...
            if (confirm('Are you sure you want to remove this image?')) {
                fetch('{{ route("localized.admin.experiences.removeMedia", ["lang" => app()->getLocale(), "id" => $experience->id]) }}', {
                    method: 'POST',
                    headers: {
