            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('localized.admin.experiences.index', ['lang' => app()->getLocale()]) }}">Experiences</a></li>
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('localized.admin.experiences.store', ['lang' => app()->getLocale()]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
