                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group m-t-20 m-b-20">
                                <input type="text"  name="meta_title" id="meta_title" value="{{ old('meta_title', $blog->meta_title) }}" class="form-control" placeholder="{{ __('blog.Enter Blog meta title') }}" />
                            </div>

                            <div class="form-group">
                                <label>{{ __('blog.Meta Description') }}</label>
                                <textarea name="meta_description" id="meta_description" class="form-control" placeholder="{{ __('blog.Enter Blog meta description') }}" maxlength="200">{{ old('meta_description', $blog->meta_description) }}</textarea>
                            ...
                            <div class="form-group m-t-20 m-b-20">
                                ...
                                <div class="tags-input-container">
                                    ...
                                    <input type="hidden" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $blog->meta_keywords) }}" />
                                </div>
